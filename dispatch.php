    ...
    <form>
      <div class="form-group row">
        ...
        <div class="col-sm-8">
			<span>
				<?php echo $contactNo; ?>
				<input type="hidden" id="contactNo" name="91234567" value="<?php echo $contactNo; ?>">
			</span>
        ...
        <div class="col-sm-8">
			<span>
				...
				<input type="hidden" id="locationOfIncident" name="CCK" value="<?php echo $locationOfIncident; ?>">
			</span>
        ...
        <div class="col-sm-8">
			<span>
				...
				<input name="desciptionOfIncident"
					type="hidden"
					id="desciptionOfIncident" value="<?php echo $descriptionOfIncident; ?>">
			</span>
